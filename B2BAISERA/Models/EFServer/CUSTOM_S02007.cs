...
namespace B2BAISERA.Models.EFServer
{
    public partial class CUSTOM_S02007
    {
        ...
        {
            if (previousValue != null && previousValue.CUSTOM_S02007.Contains(this))
            {
                previousValue.CUSTOM_S02007.Remove(this);
            }
    
            if (CUSTOM_TRANSACTIONDATA != null)
            {
                if (!CUSTOM_TRANSACTIONDATA.CUSTOM_S02007.Contains(this))
                {
                    CUSTOM_TRANSACTIONDATA.CUSTOM_S02007.Add(this);
                }
