...
namespace B2BAISERA.Models.EFServer
{
    public partial class CUSTOM_TRANSACTIONDATA
    {
        ...
        public virtual ICollection<CUSTOM_S02005_HS> CUSTOM_S02005_HS
        {
            get
            {
                if (_cUSTOM_S02005_HS == null)
                {
                    var newCollection = new FixupCollection<CUSTOM_S02005_HS>();
                    newCollection.CollectionChanged += FixupCUSTOM_S02005_HS;
                    _cUSTOM_S02005_HS = newCollection;
                }
                return _cUSTOM_S02005_HS;
            }
            set
            {
                if (!ReferenceEquals(_cUSTOM_S02005_HS, value))
                {
                    var previousValue = _cUSTOM_S02005_HS as FixupCollection<CUSTOM_S02005_HS>;
                    if (previousValue != null)
                    {
                        previousValue.CollectionChanged -= FixupCUSTOM_S02005_HS;
                    }
                    _cUSTOM_S02005_HS = value;
                    var newValue = value as FixupCollection<CUSTOM_S02005_HS>;
                    if (newValue != null)
                    {
                        newValue.CollectionChanged += FixupCUSTOM_S02005_HS;
                    }
                }
            }
        }
        private ICollection<CUSTOM_S02005_HS> _cUSTOM_S02005_HS;
    
        public virtual ICollection<CUSTOM_S02005_IS> CUSTOM_S02005_IS
        {
            get
            {
                if (_cUSTOM_S02005_IS == null)
                {
                    var newCollection = new FixupCollection<CUSTOM_S02005_IS>();
                    newCollection.CollectionChanged += FixupCUSTOM_S02005_IS;
                    _cUSTOM_S02005_IS = newCollection;
                }
                return _cUSTOM_S02005_IS;
            }
            set
            {
                if (!ReferenceEquals(_cUSTOM_S02005_IS, value))
                {
                    var previousValue = _cUSTOM_S02005_IS as FixupCollection<CUSTOM_S02005_IS>;
                    if (previousValue != null)
                    {
                        previousValue.CollectionChanged -= FixupCUSTOM_S02005_IS;
                    }
                    _cUSTOM_S02005_IS = value;
                    var newValue = value as FixupCollection<CUSTOM_S02005_IS>;
                    if (newValue != null)
                    {
                        newValue.CollectionChanged += FixupCUSTOM_S02005_IS;
                    }
                }
            }
        }
        private ICollection<CUSTOM_S02005_IS> _cUSTOM_S02005_IS;
        ...
        private void FixupCUSTOM_S02005_HS(object sender, NotifyCollectionChangedEventArgs e)
        {
            if (e.NewItems != null)
            {
                foreach (CUSTOM_S02005_HS item in e.NewItems)
                {
                    item.CUSTOM_TRANSACTIONDATA = this;
                }
            }
            ...
            if (e.OldItems != null)
            {
                foreach (CUSTOM_S02005_HS item in e.OldItems)
                {
                    if (ReferenceEquals(item.CUSTOM_TRANSACTIONDATA, this))
                    {
                        item.CUSTOM_TRANSACTIONDATA = null;
        ...
        private void FixupCUSTOM_S02005_IS(object sender, NotifyCollectionChangedEventArgs e)
        {
            if (e.NewItems != null)
            {
                foreach (CUSTOM_S02005_IS item in e.NewItems)
                {
                    item.CUSTOM_TRANSACTIONDATA = this;
                }
            }
            ...
            if (e.OldItems != null)
            {
                foreach (CUSTOM_S02005_IS item in e.OldItems)
                {
                    if (ReferenceEquals(item.CUSTOM_TRANSACTIONDATA, this))
                    {
                        item.CUSTOM_TRANSACTIONDATA = null;
