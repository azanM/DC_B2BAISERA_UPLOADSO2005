...
namespace B2BAISERA.Log
{
    public class LogEvent : DataAccessBase
    {
        ...
        public void WriteDBLog(string webServiceName, string methodName, bool acknowledge, string ticketNo, string message, string filType, string userName)
        {
